...
class Drive{
    ...
    void moveX(double x, int power){
       // double unitRotation = 734;//the magnitude of rotation caused by one unit distance
        ...
        FrontLeft.rotateFor(dFL, rotationUnits::deg, power,velocityUnits::pct, false);
        BackLeft.rotateFor(dBL, rotationUnits::deg,power, velocityUnits::pct, false);
    ...
    void moveX(double x){
       // double unitRotation = 734;//the magnitude of rotation caused by one unit distance
        ...
        double dFR =  x / unitRotation; //Change in the rotation in the Front Right Motor
        double dBR = -(x / unitRotation); //Change in the rotation in the Back Right Motor
        FrontLeft.rotateFor(dFL, rotationUnits::deg, 50,velocityUnits::pct, false);
        BackLeft.rotateFor(dBL, rotationUnits::deg,50, velocityUnits::pct, false);
        FrontRight.rotateFor(dFR, rotationUnits::deg, 50,velocityUnits::pct, false);
        BackRight.rotateFor(dBR,  rotationUnits::deg, 50,velocityUnits::pct, false);
        vex::task::sleep(500);
    }
    void moveY(double y){
       // double unitRotation = 734;//the magnitude of rotation caused by one unit distance
    ...
    void rotateBack(){
        ...
        BackLeft.setRotation(0, rotationUnits::deg);
        BackRight.setRotation(0, rotationUnits::deg);
        FrontLeft.rotateFor(piTurn,rotationUnits::deg,100,velocityUnits::pct,false);
        FrontRight.rotateFor(piTurn,rotationUnits::deg,100,velocityUnits::pct,false);
        BackLeft.rotateFor(piTurn,rotationUnits::deg,100,velocityUnits::pct,false);
        BackRight.rotateFor(piTurn,rotationUnits::deg,100,velocityUnits::pct,false);
        //vex::task::sleep(200);
    }
    ...
    int driveOperation(){
        while (true){
            ...
            //Power Mode
            double power = 1.0+Controller1.Axis2.position(percentUnits::pct)/100;
            //Joystick
            ...
            //Rotating the robot by 180 degrees
            ...
            //Printing the parameters onto the brain
    ...
    int liftOperation(){
        while (true){
            ...
            if ( (currentLiftIndex != 0) ){
                ...
                LiftMotor1.startRotateTo(pos[currentLiftIndex], rotationUnits::deg,100,velocityUnits::pct);
                 LiftMotor2.startRotateTo(pos[currentLiftIndex], rotationUnits::deg,100,velocityUnits::pct);
                vex::task::sleep(300);
                LiftMotor1.setRotation(0,rotationUnits::deg);
                LiftMotor2.setRotation(0,rotationUnits::deg);
